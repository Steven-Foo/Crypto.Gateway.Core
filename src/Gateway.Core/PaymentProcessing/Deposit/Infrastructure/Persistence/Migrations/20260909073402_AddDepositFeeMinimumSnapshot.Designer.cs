...
namespace CryptoPaymentEngine.Gateway.Core.PaymentProcessing.Deposit.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260909073402_AddDepositFeeMinimumSnapshot")]
    partial class AddDepositFeeMinimumSnapshot
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CryptoPaymentEngine.Gateway.Core.PaymentProcessing.Deposit.Domain.Deposit", b =>
                {
                    ...
                    b.Property<BigInteger>("FeeFixed")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(38,0)")
                        .HasDefaultValueSql("0");

                    b.Property<BigInteger>("FeeMinimum")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(38,0)")
                        .HasDefaultValueSql("0");
                    ...
                    b.Property<bool>("MinimumFeeApplied")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                    ...
                    b.HasIndex("Chain", "Address", "Status")
                        .HasDatabaseName("IX_Deposit_Chain_Address_Status");
